...
const Chat = () => {
  ...
  const searchUsers = async (query) => {
    ...
    try {
      const response = await axios.get(
        `${import.meta.env.VITE_API_URL}/api/chat/search?q=${encodeURIComponent(
          query
        )}`
      );
    ...
    <div className="flex h-screen bg-gray-900">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <button
                ...
                className="text-gray-200 hover:text-gray-100 cursor-pointer bg-gray-50/10 rounded-full p-2 flex items-center justify-center"
                title="Profile"
              >
                <svg
                  className="w-5 h-5"
              ...
              <div className="">
                ...
                {/* <p className="text-xs text-gray-50">@{user.username}</p> */}
              </div>
            </div>
        ...
        <div className="p-4">
          <div className="relative">
            <input
              ...
              className="w-full px-4 py-2 border border-gray-500 rounded-2xl placeholder:text-gray-500 text-gray-50 focus:outline-none"
            />
            {searchResults.length > 0 && (
              <div className="absolute top-full left-0 right-0 bg-gray-800 rounded-lg shadow-2xl z-10 mt-1">
      ...
      <div className="flex-1 flex flex-col">
        {selectedUser ? (
          <>
            {/* Chat Header */}
            <div className="p-3 border-b border--500 bg-gray-800">
              <div className="flex items-center space-x-3">
