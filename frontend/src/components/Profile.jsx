          ...
          <div className="">
            <div className="flex items-center justify-between mb-6">
              <button
                ...
                className="text-gray-200 hover:text-gray-300 bg-gray-100/10 rounded-full p-2 flex items-center justify-center cursor-pointer"
                title="Back to Chat"
              >
                <svg
                  className="w-5 h-5"
            ...
            <div className="space-y-4">
              <div className="flex justify-between">
                ...
                <input
                  ...
                  type="text"
                  required
                  className="appearance-none relative block border border-x-0 border-t-0 border-b-gray-400 placeholder-gray-500 text-gray-50 bg--700  focus:outline-none focus:ring-gray-500 focus:border-gray-500 focus:z-10 sm:text-sm"
            ...
            <div className="space-y-4">
              <div className="w-full flex flex-col items-end gap-5">
                <button
                  type="submit"
                  disabled={loading}
                  className="group relative flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-blue-800 hover:bg-blue-900 cursor-pointer focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 disabled:opacity-50"
                >
              ...
              <button
                ...
                className="group relative flex justify-center py-2 px-3 text-sm font-medium rounded-md text-red-500 transition-all  hover:bg-red-700 cursor-pointer hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-red-500"
                >
                Delete Account
              </button>
                </div>
